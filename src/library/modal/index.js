...
export default class Modal extends React.Component {
    ...
    render() {
	    ...
	    return (
			<Animation transitionName="fade" transitionAppear={true} transitionAppearTimeout={500} transitionEnter={true} transitionEnterTimeout={500} transitionLeave={true} transitionLeaveTimeout={500}>
				<div className={modalClasses} key={this.props.name}>
						<div className="modal">
