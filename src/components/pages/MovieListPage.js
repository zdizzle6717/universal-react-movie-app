            ...
            <div className="row">
                ...
                <div className="small-12">
                    ...
                    <table className="stack hover text-center">
                        ...
                        <tbody>
                            {this.state.movies.map((movie, i) => <MovieRow key={i} {...movie} synopsis={movie.synopsis.substring(0, 70) + '...'} fullName={movie.Director.firstName + ' ' + movie.Director.lastName}></MovieRow>)}
                        </tbody>
                    </table>
                </div>
